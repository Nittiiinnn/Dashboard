...
function Settings() {
    ...
    <div className="p-4 sm:p-6 md:p-8 bg-gray-50 dark:bg-gray-800 dark:text-white min-h-screen">
      ...
      {/* The ThemeToggle will be styled by its own component, just place it here */}
      <div className="bg-white p-6 rounded-lg shadow-sm dark:bg-gray-700"> {/* Wrapped ThemeToggle in a card */}
